...
final_member_pivot['Total'] = member_pivot.Member + final_member_pivot['Not Member']
...
# Percentage of Visitors who Applied to MuscleHub
ax = plt.subplot()
...
plt.show()
plt.savefig('visitor_app_percentage.png')


# In[44]:

# Percentage of Applicants who Became Members
ax = plt.subplot()
...
plt.show()
plt.savefig('percentage_of_applicant_members.png')


# In[45]:

# Percentage of Visitors who Became Members
ax = plt.subplot()
...
ax.set_yticklabels(['0%', '5%', '10%', '15%', '20%'])
plt.show()
plt.savefig('percentage_of_vistors_to_members.png')
